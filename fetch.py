#!/usr/bin/env python3
"""
Recupero codici sconto Lookfantastic da shopilo.it
Sursa: https://shopilo.it/negozi/lookfantastic.it
"""
...
SHOPILO_URL = "https://shopilo.it/negozi/lookfantastic.it"
STORE_NAME = "Lookfantastic"


def fetch_coupons(url=SHOPILO_URL):
    """Restituisce la lista dei coupon attivi per Lookfantastic da shopilo.it"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-it/codice-sconto-lookfantastic)"
    }
    try:
